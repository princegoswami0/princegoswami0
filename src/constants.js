import ccsuLogo from './assets/education_logo/ccsun.png';
import svmLogo from './assets/education_logo/ccsu.webp';
...
export const education = [
  {
    id: 0,
    img: ccsuLogo,
    school: "CCSU University, Meerut",
    date: "Sept 2024 - July 2027",
    desc: "Built a foundation in analytical thinking and problem-solving, with the aim of driving business growth through sales and client development.",
    degree: "Bachelor of Computer Applications - BCA",
  },
  {
    id: 1,
    img: svmLogo,
    school: "SVM , Nehru Nagar",
    date: "April 2023 - Aug 2024",
    grade: "79%",
    desc: "I completed my class 12 education from Saraswati Vidya Mandir , Nehru Nagar,  under the CBSE board, where I studied Physics, Chemistry, and Mathematics (PCM) .",
...

  {
    ...
    grade: "90%",
    desc: "I completed my class 10 education from Saraswati Vidya Mandir , Nehru Nagar, under the CBSE board, where I studied Science with Computer.",
    degree: "CBSE(X)",
  },
];
